...
class Player
{
    ...
    //virtual을 사용하여 자식 클래스에서 덮어서 사용가능 하게끔 만듬
...
class Archer : Player
{
    ...
    public override void Attack()
    {
        Console.WriteLine("아처의 날카로운 화살 쏘기!");
    }
}
...
class Program
{
    static void Main()
    {
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("  [주의!] 이름이 너무 짧아요. 다시 입력해 주세요.\n");
                continue;
            }
            break;
        }
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("  [주의!] 최소 HP는 60, 최소 MP는 40입니다. 다시 입력해주세요.\n");
                continue;
            }
            break;
        }
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("  [주의!] 최소 공격력은 15, 최소 방어력은 5입니다. 다시 입력해주세요.\n");
                continue;
            }
            break;
        }
        ...
        //Win + . 누르면 이모지 추가 (없는 건 사이트에서 찾는걸로)
        if (select == "1")
        {
